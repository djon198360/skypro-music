    ...
    <div className="playlist__track track">
      <div className="track__title">
        ...
        <div className="track__title-text">
          <a className="track__title-link" href="http://">{paramProps.value.title} 
          <span className="track__title-span"></span></a>
        </div>
      </div>
      <div className="track__author">
        <a className="track__author-link" href="http://">{paramProps.value.artist}</a>
      </div>
      <div className="track__album">
        <a className="track__album-link" href="http://">{paramProps.value.album}</a>
      </div>
